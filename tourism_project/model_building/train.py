...
Xtrain_path = "hf://datasets/KarmaLoop/tourism-project/Xtrain.csv"
Xtest_path = "hf://datasets/KarmaLoop/tourism-project/Xtest.csv"
ytrain_path = "hf://datasets/KarmaLoop/tourism-project/ytrain.csv"
ytest_path = "hf://datasets/KarmaLoop/tourism-project/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "tourism-project-v1.joblib"
    ...
    repo_id = "KarmaLoop/tourism-project"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="tourism-project-v1.joblib",
        path_in_repo="tourism-project-v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
